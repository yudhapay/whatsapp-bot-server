-- Script SQL untuk Setup Supabase WhatsApp Bot
...
-- 2. Buat policy untuk bucket 'templates'
...
-- 3. Buat tabel untuk log webhook (optional)
...
-- 4. Buat tabel untuk template metadata (optional)
...
-- 6. Buat function untuk cleanup log lama (optional)
...
-- 7. Buat scheduled job untuk cleanup (optional)
-- Note: Ini perlu dikonfigurasi di Supabase Dashboard > Database > Functions
-- atau menggunakan pg_cron extension
